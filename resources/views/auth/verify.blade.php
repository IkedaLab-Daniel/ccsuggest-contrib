    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 py-12" x-data="{ resending: false }">
      <div class="max-w-md mx-auto w-full">
        ...
        <div class="mb-8 text-center lg:text-left">
          ...
          <p class="text-red-700/80">We've sent you a verification link</p>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-red-100">
          ...
          <div class="bg-red-50 rounded-xl p-4 mb-6 text-center">
            <p class="text-sm text-red-600 mb-1">We sent the email to:</p>
          ...
          <form method="POST" action="{{ route('verification.resend') }}" @submit="resending = true">
            ...
            <button type="submit"
              ...
              <span class="relative z-10 flex items-center justify-center" x-show="!resending">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                </svg>
                Resend Verification Email
              </span>
              <span class="relative z-10 flex items-center justify-center" x-show="resending" x-cloak>
